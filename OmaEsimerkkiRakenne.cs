...
namespace BIMKurssi
{
    ...
    /// </summary>
    public  class OmaEsimerkkiRakenne : Epx.BIM.Models.Model3DNode, Epx.BIM.Plugins.IPluginNode
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Esimerkkirakenne"/> class.
        /// </summary>
        public OmaEsimerkkiRakenne() : this("EsimerkkiRakenne")
        {
        }
        ...
        #endregion
        /// <summary>
        /// Initializes a new instance of the <see cref="OmaEsimerkkiRakenne"/> class.
        /// Tässä konstruktorissa alustetaan oletuarvot parametreille
        /// </summary>
        /// <param name="name">The name.</param>
        public OmaEsimerkkiRakenne(string name) : base(name)
        {
            Thickness = 50;
            Width = 150;
            Origin = new Point3D();
